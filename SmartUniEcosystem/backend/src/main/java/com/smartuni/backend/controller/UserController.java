...
import com.smartuni.backend.entity.User;
import com.smartuni.backend.repository.UserRepository;
...
public class UserController {
    ...
    @GetMapping
    public List<User> get(User probe) {
    ...
    public User patch(@PathVariable String id, @RequestBody Map<String, Object> updates) {
        ...
        org.springframework.util.ReflectionUtils.doWithFields(User.class, field -> {
