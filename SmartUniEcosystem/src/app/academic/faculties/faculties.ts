...
export class FacultiesComponent implements OnInit {
  ...
  getAction(
    type: 'exportCsv' | 'exportPdf' | 'openModal' | 'delete',
    item?: Department,
    ...
    switch (type) {
      case 'exportCsv':
        return {
          ...
          type: 'secondary',
          size: 'sm',
          tooltip: 'Export all departments to CSV',
          ariaLabel: 'Export departments as CSV',
        } as DynamicAction;
      case 'exportPdf':
        return {
          label: 'Export PDF',
          ...
          type: 'secondary',
          size: 'sm',
          tooltip: 'Export faculty structure to PDF',
          ariaLabel: 'Export departments as PDF',
        } as DynamicAction;
      case 'openModal':
        return {
          ...
          ariaLabel: 'Add a new department',
        } as DynamicAction;
      case 'delete':
        return {
          label: 'Delete',
          ...
          type: 'danger',
          size: 'sm',
          tooltip: `Delete department ${item?.name || ''}`,
          ariaLabel: `Delete ${item?.name || 'department'}`,
        } as DynamicAction;
      default:
        return undefined;
    }
