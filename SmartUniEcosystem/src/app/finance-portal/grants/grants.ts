      ...
      <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p class="text-slate-500 mt-1">
            Manage merit-based scholarships, financial aid, and sibling waivers.
          </p>
        </div>
        <button
          class="px-5 py-2.5 bg-emerald-500 text-white rounded-xl shadow-lg hover:-translate-y-0.5 transition-all font-bold flex items-center gap-2"
        >
          <svg
          ...
          <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
            <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
              ...
              <td class="px-6 py-4 text-sm font-bold text-slate-700 dark:text-slate-300">
                Merit Scholarship (CGPA > 3.8)
              </td>
              <td class="px-6 py-4 text-center">
                <span
                  class="px-2.5 py-1 bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400 rounded-md text-sm font-black"
                  >50%</span
                >
              </td>
              <td class="px-6 py-4">
              ...
              <td class="px-6 py-4 text-right">
                <button
                  class="text-xs font-bold text-slate-400 hover:text-slate-700 dark:hover:text-slate-300 transition-colors"
                >
                  Edit
                </button>
              </td>
            ...
            <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
              ...
              <td class="px-6 py-4 text-center">
                <span
                  class="px-2.5 py-1 bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-400 rounded-md text-sm font-black"
                  >20%</span
                >
              </td>
              <td class="px-6 py-4">
