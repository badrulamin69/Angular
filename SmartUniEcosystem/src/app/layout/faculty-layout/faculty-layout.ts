  ...
  template: `
    <div class="min-h-screen bg-slate-50 dark:bg-slate-900 transition-colors duration-300 flex">
      ...
      >
        ...
        >
          <div
            class="w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-white font-bold text-xl shadow-lg shrink-0"
          >
            F
          </div>
          <div
        ...
        <div class="flex-1 overflow-y-auto py-6 px-3 custom-scrollbar">
          <div class="space-y-8">
            ...
            <div>
              <p
                *ngIf="isSidebarOpen()"
                class="px-3 text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider mb-3"
              >
                Main
              </p>
              <ul class="space-y-1">
                <li>
                  <a
                    ...
                    routerLinkActive="bg-indigo-50 text-indigo-600 dark:bg-indigo-500/10 dark:text-indigo-400 font-bold"
      ...
      >
        ...
        >
          <div class="flex items-center gap-4">
            ...
            <div
              class="hidden sm:flex items-center bg-slate-100 dark:bg-slate-800 rounded-full px-4 py-2 w-64 border border-transparent focus-within:border-indigo-500 focus-within:bg-white dark:focus-within:bg-slate-900 transition-all"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
          ...
          <div class="flex items-center gap-4">
            ...
            <div class="relative pl-4 border-l border-slate-200 dark:border-slate-800">
              ...
              >
                ...
                <div
                  class="w-10 h-10 rounded-full bg-slate-200 dark:bg-slate-700 border-2 border-indigo-500 overflow-hidden hover:ring-2 hover:ring-indigo-500/30 transition-all"
                >
                  <img
                    [src]="
                      user()?.profilePhoto ||
                      'https://api.dicebear.com/7.x/avataaars/svg?seed=' + (user()?.name || 'Sarah')
                    "
                    alt="Faculty Avatar"
              ...
              >
                <div class="px-4 py-3 border-b border-slate-100 dark:border-slate-800 mb-1">
                  ...
                  <p class="text-xs text-slate-500 truncate mt-0.5">
                    {{ user()?.email || 'faculty@smartuni.edu' }}
                  </p>
                </div>

                <a
                  routerLink="/faculty/profile"
                  (click)="closeDropdown()"
                  class="flex items-center px-4 py-2.5 text-sm font-medium text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800/50 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="18"
