  ...
  template: `
    <div class="min-h-screen bg-slate-50 dark:bg-slate-900 transition-colors duration-300 flex">
      ...
      >
        ...
        >
          <div
            class="w-10 h-10 rounded-xl bg-gradient-to-br from-violet-600 to-fuchsia-600 flex items-center justify-center text-white font-bold text-xl shadow-lg shrink-0"
          >
            <svg
            ...
            >
              <path d="m22 10-7.5 4.13a2.5 2.5 0 0 1-2.38 0L2 10l9.31-5.12a2.5 2.5 0 0 1 2.38 0Z" />
              <path
                d="M6 12.2v4.5a2.5 2.5 0 0 0 1.25 2.16l3.56 2.05a2.5 2.5 0 0 0 2.38 0l3.56-2.05a2.5 2.5 0 0 0 1.25-2.16v-4.5"
              />
            </svg>
          </div>
          <div
              ...
              <ul class="space-y-1">
                <li>
                  <a
                    ...
                    routerLinkActive="bg-violet-50 text-violet-600 dark:bg-violet-500/10 dark:text-violet-400 font-bold"
              ...
              <ul class="space-y-1">
                <li>
                  ...
                  >
                    ...
                    <span *ngIf="isSidebarOpen()" class="ml-3">Live Sessions</span>
                  </a>
                </li>
                <li>
                  <a
              ...
              <ul class="space-y-1">
                <li>
                  ...
                  >
                    ...
                    <span *ngIf="isSidebarOpen()" class="ml-3">Certificates</span>
                  </a>
                </li>
              </ul>
            </div>
      ...
      >
        ...
        >
          <div class="flex items-center gap-4">
            ...
            <div
              class="hidden sm:flex items-center bg-slate-100 dark:bg-slate-800 rounded-full px-4 py-2 w-64 border border-transparent focus-within:border-violet-500 focus-within:bg-white dark:focus-within:bg-slate-900 transition-all"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
          ...
          <div class="flex items-center gap-4">
            ...
            <div class="relative pl-4 border-l border-slate-200 dark:border-slate-800">
              ...
              >
                ...
                <div
                  class="w-10 h-10 rounded-full bg-slate-200 dark:bg-slate-700 border-2 border-violet-500 overflow-hidden hover:ring-2 hover:ring-violet-500/30 transition-all"
                >
                  <img
              ...
              >
                <div class="px-4 py-3 border-b border-slate-100 dark:border-slate-800 mb-1">
                  ...
                  <p class="text-xs text-slate-500 truncate mt-0.5">
                    {{ user()?.email || 'lms@smartuni.edu' }}
                  </p>
                </div>

                <a
                  routerLink="/lms/profile"
                  class="flex items-center px-4 py-2.5 text-sm font-medium text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800/50 hover:text-violet-600 dark:hover:text-violet-400 transition-colors"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="18"
