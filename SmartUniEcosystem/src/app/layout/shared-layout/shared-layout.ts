  ...
  template: `
    <div class="min-h-screen bg-slate-50 dark:bg-slate-900 transition-colors duration-300 flex">
      ...
      >
        ...
        >
          <div
            class="w-10 h-10 rounded-xl bg-sky-500 flex items-center justify-center text-white font-bold text-xl shadow-lg shrink-0"
          >
            <svg
          ...
          >
            <span class="font-black text-lg text-slate-900 dark:text-white leading-tight"
              >Unified Hub</span
            >
            <span class="text-[10px] uppercase tracking-widest text-sky-500 font-semibold"
              >Workspace</span
            >
          </div>
        </div>
          ...
          <div class="space-y-8">
            ...
            <div>
              ...
              <ul class="space-y-1">
                <li>
                  <a
                    routerLink="/shared/hub"
                    routerLinkActive="bg-sky-50 text-sky-600 dark:bg-sky-500/10 dark:text-sky-400 font-bold"
            ...
            <div>
              ...
              <ul class="space-y-1">
                <li>
                  <a
                    routerLink="/shared/communication"
                    routerLinkActive="bg-sky-50 text-sky-600 dark:bg-sky-500/10 dark:text-sky-400 font-bold"
                    class="flex items-center px-3 py-2.5 rounded-xl text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800/50 hover:text-slate-900 dark:hover:text-white transition-all group"
                  >
                    <svg
            ...
            <div>
              ...
              <ul class="space-y-1">
                ...
                <li>
                  <a
                    href="/"
                    class="flex items-center px-3 py-2.5 rounded-xl text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800/50 hover:text-slate-900 dark:hover:text-white transition-all group mt-6"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="20"
      ...
      >
        ...
        >
          <div class="flex items-center gap-4">
            ...
            <div
              class="hidden sm:flex items-center bg-slate-100 dark:bg-slate-800 rounded-full px-4 py-2 w-64 border border-transparent focus-within:border-sky-500 focus-within:bg-white dark:focus-within:bg-slate-900 transition-all"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
          ...
          <div class="flex items-center gap-4">
            ...
            <button class="relative p-2 text-slate-500 hover:text-sky-500 transition-colors">
              ...
              <span
                class="absolute top-1 right-1 w-2.5 h-2.5 bg-red-500 border-2 border-white dark:border-slate-900 rounded-full"
              ></span>
            </button>
            ...
            <div class="relative pl-4 border-l border-slate-200 dark:border-slate-800">
              ...
              >
                ...
                <div
                  class="w-10 h-10 rounded-full bg-slate-200 dark:bg-slate-700 border-2 border-sky-500 overflow-hidden hover:ring-2 hover:ring-sky-500/30 transition-all"
                >
                  <img
              ...
              >
                ...
                <a
                  routerLink="/shared/settings"
                  class="flex items-center px-4 py-2.5 text-sm font-medium text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800/50 hover:text-sky-600 dark:hover:text-sky-400 transition-colors"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="18"
