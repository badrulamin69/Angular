      ...
      <aside [ngClass]="{'w-64': isSidebarOpen(), 'w-20': !isSidebarOpen()}" 
        ...
        <div class="flex-1 overflow-y-auto py-6 px-3 custom-scrollbar">
          <div class="space-y-8">
            <!-- MAIN -->
            <div>
              <p *ngIf="isSidebarOpen()" class="px-3 text-xs font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-4">Main Ops</p>
              <ul class="space-y-1">
                <li>
            ...
            <!-- ACADEMIC OPS -->
            <div>
              <p *ngIf="isSidebarOpen()" class="px-3 text-xs font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-4">Academic Admin</p>
              <ul class="space-y-1">
                <li>
                ...
                <li>
                  <a routerLink="/staff/exams" routerLinkActive="bg-teal-50 text-teal-600 dark:bg-teal-500/10 dark:text-teal-400 font-bold" class="flex items-center px-3 py-2.5 rounded-xl text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800/50 hover:text-slate-900 dark:hover:text-white transition-all group">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="shrink-0 group-hover:scale-110 transition-transform"><path d="M22 10v6M2 10v6"/><path d="M6 10V4a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v6"/><rect width="20" height="8" x="2" y="10" rx="2"/><path d="M11 15.5a.5.5 0 1 0 0 1 .5.5 0 1 0 0-1Z"/><path d="M13 15.5a.5.5 0 1 0 0 1 .5.5 0 1 0 0-1Z"/></svg>
            ...
            <!-- CAMPUS RESOURCES -->
            <div>
              <p *ngIf="isSidebarOpen()" class="px-3 text-xs font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-4">Campus Resources</p>
              <ul class="space-y-1">
                <li>
                  <a routerLink="/staff/library" routerLinkActive="bg-teal-50 text-teal-600 dark:bg-teal-500/10 dark:text-teal-400 font-bold" class="flex items-center px-3 py-2.5 rounded-xl text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800/50 hover:text-slate-900 dark:hover:text-white transition-all group">
                ...
                <li>
                  <a routerLink="/staff/hostel" routerLinkActive="bg-teal-50 text-teal-600 dark:bg-teal-500/10 dark:text-teal-400 font-bold" class="flex items-center px-3 py-2.5 rounded-xl text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800/50 hover:text-slate-900 dark:hover:text-white transition-all group">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="shrink-0 group-hover:scale-110 transition-transform"><path d="M3 21h18"/><path d="M3 7v1a3 3 0 0 0 6 0V7"/><path d="M9 7v1a3 3 0 0 0 6 0V7"/><path d="M15 7v1a3 3 0 0 0 6 0V7"/><path d="M19 21v-4a2 2 0 0 1 2-2v-2H3v2a2 2 0 0 1 2 2v4"/><path d="M9 21v-4a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v4"/></svg>
                    <span *ngIf="isSidebarOpen()" class="ml-3">Hostel & Housing</span>
                  </a>
                </li>
                <li>
                  <a routerLink="/staff/transport" routerLinkActive="bg-teal-50 text-teal-600 dark:bg-teal-500/10 dark:text-teal-400 font-bold" class="flex items-center px-3 py-2.5 rounded-xl text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800/50 hover:text-slate-900 dark:hover:text-white transition-all group">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="shrink-0 group-hover:scale-110 transition-transform"><path d="M8 6V4c0-1.1.9-2 2-2h4c1.1 0 2 .9 2 2v2"/><rect width="16" height="12" x="4" y="6" rx="2"/><path d="M12 12h.01"/><path d="M16 12h.01"/><path d="M8 12h.01"/><path d="M10 18h4"/><path d="M20 18h2"/><path d="M2 18h2"/></svg>
