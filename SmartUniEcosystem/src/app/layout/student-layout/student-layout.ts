  ...
  template: `
    <div class="min-h-screen bg-slate-50 dark:bg-slate-900 transition-colors duration-300 flex">
      ...
      >
        ...
        >
          <div
            class="w-10 h-10 rounded-xl bg-gradient-to-br from-mit-red to-primary-600 flex items-center justify-center text-white font-bold text-xl shadow-lg shrink-0"
          >
            S
          </div>
          <div
              ...
              <ul class="space-y-1">
                <li>
                  <a
                    ...
                    routerLinkActive="bg-red-50 text-mit-red dark:bg-red-500/10 dark:text-red-400 font-bold"
      ...
      >
        ...
        >
          <div class="flex items-center gap-4">
            ...
            <div
              class="hidden sm:flex items-center bg-slate-100 dark:bg-slate-800 rounded-full px-4 py-2 w-64 border border-transparent focus-within:border-mit-red focus-within:bg-white dark:focus-within:bg-slate-900 transition-all"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
          ...
          <div class="flex items-center gap-4">
            ...
            <div class="relative pl-4 border-l border-slate-200 dark:border-slate-800">
              ...
              >
                ...
                <div
                  class="w-10 h-10 rounded-full bg-slate-200 dark:bg-slate-700 border-2 border-mit-red overflow-hidden hover:ring-2 hover:ring-mit-red/30 transition-all"
                >
                  <img
              ...
              >
                <div class="px-4 py-3 border-b border-slate-100 dark:border-slate-800 mb-1">
                  ...
                  <p class="text-xs text-slate-500 truncate mt-0.5">
                    {{ user()?.email || 'student@smartuni.edu' }}
                  </p>
                </div>

                <a
                  routerLink="/student/profile"
                  class="flex items-center px-4 py-2.5 text-sm font-medium text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800/50 hover:text-mit-red transition-colors"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="18"
