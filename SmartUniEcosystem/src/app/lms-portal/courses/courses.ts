  ...
  template: `
    <div class="space-y-6 animate-fade-in-up">
      ...
      <div *ngIf="!isPlaying()" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <!-- Course Card 1 -->
        <div
          class="glass-panel overflow-hidden group cursor-pointer hover:-translate-y-1 transition-all flex flex-col"
          (click)="openPlayer()"
        >
          <div class="h-40 bg-gradient-to-br from-slate-800 to-slate-900 relative">
            <div
              ...
              style="background-image: url('https://images.unsplash.com/photo-1555066931-4365d14bab8c?auto=format&fit=crop&q=80&w=800')"
            ></div>
            <div
            ...
            >
              <div
                class="w-12 h-12 rounded-full bg-white text-slate-900 flex items-center justify-center pl-1 shadow-xl"
              >
                <svg
          ...
          <div class="p-5 flex-1 flex flex-col">
            ...
            <h3 class="font-black text-slate-900 dark:text-white text-lg mb-2 leading-tight">
              Fullstack Angular & Node.js Mastery
            </h3>
            <p class="text-sm text-slate-500 line-clamp-2 mb-4 flex-1">
              Learn to build scalable enterprise web applications from scratch using Angular 19 and
        ...
        >
          <div class="h-40 bg-gradient-to-br from-fuchsia-800 to-fuchsia-900 relative">
            <div
              class="absolute inset-0 bg-cover bg-center opacity-40 mix-blend-overlay"
              style="background-image: url('https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&fit=crop&q=80&w=800')"
            ></div>
          </div>
          <div class="p-5 flex-1 flex flex-col">
            <div class="flex justify-between items-start mb-2">
              <span
                class="text-xs font-bold text-fuchsia-600 dark:text-fuchsia-400 uppercase tracking-wider"
                >Cybersecurity</span
              >
            </div>
            <h3 class="font-black text-slate-900 dark:text-white text-lg mb-2 leading-tight">
            ...
            <p class="text-sm text-slate-500 line-clamp-2 mb-4 flex-1">
              Master penetration testing and secure your infrastructure against modern cyber
              threats.
            </p>
      ...
      <div *ngIf="isPlaying()" class="animate-fade-in">
        <button
          (click)="closePlayer()"
          class="mb-4 text-sm font-bold text-slate-500 hover:text-slate-900 dark:hover:text-white flex items-center gap-2 transition-colors"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div class="lg:col-span-2 space-y-4">
            ...
            <div
              class="w-full aspect-video bg-slate-900 rounded-2xl overflow-hidden relative shadow-2xl flex items-center justify-center"
            >
              <div
                class="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent z-10 pointer-events-none"
              ></div>
              ...
              <div class="absolute bottom-0 inset-x-0 p-4 z-20 flex flex-col gap-2">
                ...
                <div class="flex justify-between items-center text-white mt-1">
                  ...
                  <div class="flex items-center gap-4">
                    <button
                      class="text-xs font-bold hover:text-violet-400 transition-colors border border-white/40 px-2 py-0.5 rounded"
                    >
                      1x
                    </button>
                    <button class="hover:text-violet-400 transition-colors">
            ...
            <h2 class="text-2xl font-black text-slate-900 dark:text-white mt-4">
              Module 4: Building Responsive Layouts
            </h2>
            <p class="text-slate-500 leading-relaxed">
              In this module, we explore modern CSS techniques including Flexbox, CSS Grid, and
              Tailwind CSS to build fluid interfaces that adapt perfectly to any device screen size.
            </p>
          </div>
          ...
          <div class="glass-panel overflow-hidden flex flex-col h-[500px]">
            ...
            <div class="flex-1 overflow-y-auto custom-scrollbar p-2 space-y-1">
              <!-- Module Items -->
              <button
                class="w-full text-left p-3 rounded-lg flex items-start gap-3 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors text-slate-500"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="18"
              ...
              <button
                class="w-full text-left p-3 rounded-lg flex items-start gap-3 bg-violet-50 dark:bg-violet-900/20 text-violet-900 dark:text-violet-100 border border-violet-200 dark:border-violet-800/50 transition-colors"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="18"
                  ...
                  stroke-linecap="round"
                  stroke-linejoin="round"
                  class="text-violet-500 mt-0.5 shrink-0"
                >
                  <polygon points="5 3 19 12 5 21 5 3" />
                </svg>
                <div>
                  <p class="text-sm font-bold line-clamp-1 text-violet-700 dark:text-violet-300">
                    Module 4: Building Responsive Layouts
                  </p>
              ...
              <button
                class="w-full text-left p-3 rounded-lg flex items-start gap-3 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors text-slate-400"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="18"
                ...
                <div>
                  <p class="text-sm font-bold line-clamp-1 text-slate-700 dark:text-slate-300">
