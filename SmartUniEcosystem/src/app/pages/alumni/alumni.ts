      ...
      <section class="relative py-24 px-4 overflow-hidden">
        <div class="container mx-auto max-w-6xl">
          <div class="mb-16 text-center">
            <span
              class="inline-flex items-center px-4 py-2 rounded-full bg-mit-red/10 text-mit-red text-xs font-black uppercase tracking-[0.35em] mb-4"
              >Alumni Directory</span
            >
            <h1 class="text-4xl md:text-5xl font-black tracking-tight mb-4">
              Graduated Students, Faculty, and Officers
            </h1>
            <p class="text-slate-600 dark:text-slate-300 text-lg max-w-3xl mx-auto">
              Browse the full alumni directory with rich profile details for students, teachers, and
              staff officers. Every record includes contact, department, passing year, and
          ...
          <div class="grid gap-6 lg:grid-cols-3 mb-16">
            <div class="glass-panel p-6 rounded-3xl shadow-xl">
              ...
              <p class="text-sm text-slate-500 dark:text-slate-400">
                Former graduates carrying the legacy of campus excellence.
              </p>
            ...
            <div class="glass-panel p-6 rounded-3xl shadow-xl">
              ...
              <p class="text-sm text-slate-500 dark:text-slate-400">
                Ex-faculty members and retired academic leaders.
              </p>
            ...
            <div class="glass-panel p-6 rounded-3xl shadow-xl">
              ...
              <p class="text-sm text-slate-500 dark:text-slate-400">
                Administrative alumni who built the university operations.
              </p>
          ...
          <section class="space-y-12">
            <div>
              <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-6">
                <div>
                  ...
                  <p class="text-slate-500 dark:text-slate-400">
                    Completed student graduates with passing year, session, department and contact
                    details.
                  </p>
                </div>
              </div>
              <div class="grid gap-4">
                <div
                  *ngFor="let alum of studentAlumni()"
                  class="glass-panel p-6 rounded-3xl shadow-xl border border-slate-200 dark:border-slate-800"
                >
                  <div class="flex flex-col md:flex-row md:justify-between gap-4">
                    <div>
                      <p
                        class="text-xs uppercase tracking-[0.28em] text-slate-500 dark:text-slate-400 font-black mb-2"
                      >
                        Student
                      </p>
                      <h3 class="text-2xl font-bold">{{ alum.name }}</h3>
                      <p class="text-sm text-slate-600 dark:text-slate-300">
                        {{ alum.department }} • {{ alum.session }}
                      </p>
                    </div>
                  ...
                  <div
                    class="grid gap-3 sm:grid-cols-2 lg:grid-cols-4 mt-6 text-sm text-slate-600 dark:text-slate-300"
                  >
                    ...
                    <div class="col-span-1 lg:col-span-2">
                      <span class="font-semibold">Address</span><br />{{ alum.address }}
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div>
              <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-6">
                <div>
                  ...
                  <p class="text-slate-500 dark:text-slate-400">
                    Retired or past teachers who once shaped academic instruction.
                  </p>
                </div>
              </div>
              <div class="grid gap-4">
                <div
                  *ngFor="let alum of teacherAlumni()"
                  class="glass-panel p-6 rounded-3xl shadow-xl border border-slate-200 dark:border-slate-800"
                >
                  <div class="flex flex-col md:flex-row md:justify-between gap-4">
                    <div>
            ...
            <div>
              <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-6">
                <div>
                  ...
                  <p class="text-slate-500 dark:text-slate-400">
                    Administrative alumni who once directed campus operations.
                  </p>
                </div>
              </div>
              <div class="grid gap-4">
                <div
                  *ngFor="let alum of staffAlumni()"
                  class="glass-panel p-6 rounded-3xl shadow-xl border border-slate-200 dark:border-slate-800"
                >
                  <div class="flex flex-col md:flex-row md:justify-between gap-4">
                    <div>
