...
@Component({
  ...
  template: `
    <div
      class="min-h-screen pt-24 pb-12 bg-slate-50 dark:bg-slate-950 px-4 flex items-center justify-center"
    >
      <div class="max-w-2xl w-full">
        <div
          id="receipt-box"
          class="glass-panel p-10 space-y-8 relative overflow-hidden bg-white dark:bg-slate-900 shadow-2xl rounded-3xl border border-slate-200 dark:border-slate-800"
        >
          <!-- Receipt Header for PDF -->
          <div
            class="flex justify-between items-start border-b border-slate-100 dark:border-slate-800 pb-8"
          >
            <div>
              <h2
                class="text-3xl font-black text-slate-900 dark:text-white uppercase tracking-tighter"
              >
                Receipt
              </h2>
            ...
            <div class="text-right">
              <div
                class="w-12 h-12 bg-mit-red text-white rounded-lg flex items-center justify-center font-bold text-2xl mx-auto md:ml-auto"
              >
                S
              </div>
            </div>
          ...
          <div class="space-y-4">
            ...
            <div
              class="border-t border-slate-100 dark:border-slate-800 pt-4 flex justify-between items-center"
            >
              <span class="text-lg font-bold text-slate-900 dark:text-white">Total Amount</span>
              <span class="text-3xl font-black text-mit-red"
                >{{ amount | number: '1.2-2' }} BDT</span
              >
            </div>
          </div>

          <div
            class="bg-blue-50 dark:bg-blue-900/10 p-6 rounded-2xl border border-blue-100 dark:border-blue-800/50"
          >
            <p
              class="text-sm text-blue-800 dark:text-blue-300 leading-relaxed italic text-center font-medium"
            >
          ...
          <div class="flex flex-col sm:flex-row gap-4 pt-4 no-print">
            <button
              ...
              class="flex-1 px-8 py-4 bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-2xl font-bold hover:scale-[1.02] transition-all flex items-center justify-center gap-2 shadow-xl"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
            ...
            <a
              ...
              class="flex-1 px-8 py-4 bg-white dark:bg-slate-800 text-slate-900 dark:text-white border border-slate-200 dark:border-slate-800 rounded-2xl font-bold hover:bg-slate-50 dark:hover:bg-slate-700 transition-all flex items-center justify-center"
            >
              Go to Portal
            </a>
          </div>
