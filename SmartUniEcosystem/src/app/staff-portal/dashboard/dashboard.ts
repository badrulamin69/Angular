  ...
  template: `
    <div class="space-y-8 animate-fade-in-up pb-12">
      ...
      <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1
            class="text-4xl font-black text-slate-900 dark:text-white tracking-tight leading-none"
          >
            Command Center
          </h1>
          <p class="text-slate-500 mt-2 font-medium">
            Academic Year 2026-27 • Institutional Performance Overview
          </p>
        </div>
        <div class="flex items-center gap-3">
          <div
            class="px-4 py-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl flex items-center gap-2 shadow-sm"
          >
          ...
          <button
            ...
            class="px-5 py-2.5 bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-xl shadow-xl hover:-translate-y-0.5 transition-all font-bold text-sm"
          >
            Quick Action
          </button>
        </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <div
          class="glass-panel p-6 bg-gradient-to-br from-indigo-500/5 to-transparent border-indigo-500/10"
        >
          <div class="flex items-center justify-between mb-4">
            <div
              class="w-10 h-10 rounded-lg bg-indigo-500/20 text-indigo-600 dark:text-indigo-400 flex items-center justify-center"
            >
              <svg
            ...
            <span
              class="text-[10px] font-black text-green-500 bg-green-500/10 px-2 py-0.5 rounded-full"
              >+{{ studentGrowthPct() }}%</span
            >
          </div>
        ...
        <div
          class="glass-panel p-6 bg-gradient-to-br from-mit-red/5 to-transparent border-mit-red/10"
        >
          <div class="flex items-center justify-between mb-4">
            <div
              class="w-10 h-10 rounded-lg bg-mit-red/20 text-mit-red flex items-center justify-center"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
            ...
            <span
              class="text-[10px] font-black text-amber-500 bg-amber-500/10 px-2 py-0.5 rounded-full"
              >{{ stats().pendingApps > 0 ? 'Active' : 'Clear' }}</span
            >
          </div>
          <p class="text-xs font-black text-slate-400 uppercase tracking-widest mb-1">
            Pending Apps
        ...
        <div
          class="glass-panel p-6 bg-gradient-to-br from-emerald-500/5 to-transparent border-emerald-500/10"
        >
          <div class="flex items-center justify-between mb-4">
            <div
              class="w-10 h-10 rounded-lg bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 flex items-center justify-center"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
            ...
            <span
              class="text-[10px] font-black text-green-500 bg-green-500/10 px-2 py-0.5 rounded-full"
              >{{ feeCollectionPct() }}% Collected</span
            >
          </div>
          <p class="text-xs font-black text-slate-400 uppercase tracking-widest mb-1">
            Fee Collection
        ...
        <div
          class="glass-panel p-6 bg-gradient-to-br from-amber-500/5 to-transparent border-amber-500/10"
        >
          <div class="flex items-center justify-between mb-4">
            <div
              class="w-10 h-10 rounded-lg bg-amber-500/20 text-amber-600 dark:text-amber-400 flex items-center justify-center"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
            ...
            <span
              class="text-[10px] font-black text-slate-400 bg-slate-500/10 px-2 py-0.5 rounded-full"
              >{{ hostelCapacityPct() }}% Capacity</span
            >
          </div>
          <p class="text-xs font-black text-slate-400 uppercase tracking-widest mb-1">
            Hostel Status
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-6">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              class="text-xs font-black text-mit-red uppercase tracking-widest hover:underline"
            >
              View Pipeline
            </button>
          </div>
              ...
              <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
                ...
                >
                  ...
                  <td class="px-6 py-4 text-right">
                    <button
                      routerLink="/staff/admissions"
                      class="w-8 h-8 rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-500 flex items-center justify-center hover:bg-mit-red hover:text-white transition-all ml-auto"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="14"
        ...
        <div class="space-y-8">
          <div class="glass-panel p-6">
            <h4
              class="font-black text-slate-900 dark:text-white uppercase tracking-widest text-xs mb-6 border-b border-slate-100 dark:border-slate-800 pb-4"
            >
              Campus Activity Log
            </h4>
            <div class="space-y-6">
              <div
                *ngFor="let log of activityLogs()"
                class="relative pl-6 before:absolute before:left-0 before:top-2 before:w-2 before:h-2 before:rounded-full"
          ...
          <div class="glass-card p-6 bg-slate-900 text-white relative overflow-hidden group">
            <div
              class="absolute -right-8 -bottom-8 w-32 h-32 bg-mit-red/20 rounded-full blur-3xl transition-all group-hover:scale-150"
            ></div>
            <h4 class="font-black text-xl mb-2 relative z-10">Institutional Reports</h4>
            <p class="text-xs text-slate-400 mb-6 relative z-10 leading-relaxed">
              Download complete financial and academic performance metrics for Q2 2026.
            </p>
            <button
              (click)="downloadReport()"
              class="w-full py-3 bg-white text-slate-900 rounded-xl font-bold text-xs relative z-10 hover:scale-105 transition-transform"
            >
              Download PDF
            </button>
          </div>
    ...
    >
      ...
      <div class="glass-panel w-full max-w-md p-6 relative z-10 animate-fade-in-up">
        ...
        <div class="space-y-3">
          <button
            (click)="runQuickAction('backup')"
            class="w-full flex items-center gap-4 p-4 bg-slate-50 dark:bg-slate-800 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 rounded-xl border border-slate-200 dark:border-slate-700 transition-colors text-left group"
          >
            <div
              class="w-10 h-10 rounded-lg bg-indigo-100 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 flex items-center justify-center shrink-0"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="18"
          ...
          <button
            (click)="runQuickAction('cache')"
            class="w-full flex items-center gap-4 p-4 bg-slate-50 dark:bg-slate-800 hover:bg-amber-50 dark:hover:bg-amber-900/20 rounded-xl border border-slate-200 dark:border-slate-700 transition-colors text-left group"
          >
            <div
              class="w-10 h-10 rounded-lg bg-amber-100 dark:bg-amber-900/30 text-amber-600 dark:text-amber-400 flex items-center justify-center shrink-0"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="18"
          ...
          <button
            (click)="runQuickAction('announcement')"
            class="w-full flex items-center gap-4 p-4 bg-slate-50 dark:bg-slate-800 hover:bg-emerald-50 dark:hover:bg-emerald-900/20 rounded-xl border border-slate-200 dark:border-slate-700 transition-colors text-left group"
          >
            <div
              class="w-10 h-10 rounded-lg bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400 flex items-center justify-center shrink-0"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="18"
        ...
        <div
          *ngIf="quickActionFeedback()"
          class="mt-4 p-3 bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 rounded-xl text-sm font-semibold text-emerald-700 dark:text-emerald-400 flex items-center gap-2"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
...
export class StaffDashboardComponent implements OnInit {
  ...
  runQuickAction(type: string) {
    ...
    const newLog = {
      title:
        type === 'backup'
          ? 'Database backup triggered by staff'
          : type === 'cache'
            ? 'Application cache cleared by staff'
