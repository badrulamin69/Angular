        ...
        <div class="space-y-6">
          ...
          <div class="space-y-4">
            ...
            <div class="glass-panel p-5">
              <div *ngFor="let leave of leaveRequests()" class="flex items-center justify-between">
                <div>
...
export class FacultyDashboardComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.http.get<any[]>('http://localhost:3000/leaveRequests').subscribe(leaves => {
      this.leaveRequests.set(leaves.filter(l => l.userId === currentUser.id));
    });
  }
}
